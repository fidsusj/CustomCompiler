...
import dhbw.testBase.compiler.FileReader;

public abstract class TestBaseIntf {
    FileReader m_fileReader;
	
    // read and execute a sequence of test cases
    public abstract void readAndExecuteTestSequence() throws Exception;
	
	// read and execute one test case
    public abstract void readAndExecuteTestCase() throws Exception;
	
	// read the content of a test section (after $IN or $OUT)
    public abstract String readTestContent() throws Exception;
	
	// check that input is $IN and consume it
    public abstract void readDollarIn() throws Exception;
	
	// check that output is $OUT and consume it
    public abstract void readDollarOut() throws Exception;
	
    // creates a Test object from an input file
    public TestBaseIntf(String fileName) throws Exception {
    ...
    public void executeTestCase(String input, String expectedOutput) throws Exception {
		String result;
		try {
